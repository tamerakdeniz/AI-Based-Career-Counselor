...
import { MessageCircle, MapPin, Clock, CheckCircle, ArrowRight } from 'lucide-react';
    ...
    <div className="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200 p-6 border border-gray-100">
      ...
      <div className="flex items-start justify-between mb-4">
        <div className="flex-1">
          ...
          <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getFieldColor(roadmap.field)}`}>
            {roadmap.field}
          </span>
        </div>
      ...
      <div className="flex items-center space-x-2 mb-4 p-3 bg-gray-50 rounded-lg">
        ...
        <div className="flex-1">
          <p className="text-xs text-gray-500 uppercase tracking-wide">Next Milestone</p>
          <p className="text-sm font-medium text-gray-900">{roadmap.nextMilestone}</p>
        </div>
      </div>
      ...
      <div className="flex space-x-3">
        ...
        <button className="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-2 rounded-lg font-medium transition-colors duration-200 flex items-center justify-center space-x-2">
